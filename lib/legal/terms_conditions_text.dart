...
const List<LegalSection> termsConditionsSections = [
  ...
  LegalSection(
    ...
    'RallyStats es una herramienta para anotar en vivo estadísticas de vóley (saque, '
        ...
        'funciones (pizarra táctica, zona de destino, estadísticas más allá de un partido, y el '
        'tope de partidos guardados) están limitadas en la versión gratuita y se desbloquean con '
        'una suscripción mensual paga ("versión premium"), según se detalla en la sección 04.\n\n'
  ...
  LegalSection(
    ...
    'La versión premium de RallyStats en Android se contrata como una suscripción mensual '
        ...
        'gratuita e indefinida, con las limitaciones propias de esa versión (tope de 3 partidos '
        'guardados en el archivo, estadística disponible para un único partido, sin pizarra '
        'táctica ni zona de destino).\n\n'
