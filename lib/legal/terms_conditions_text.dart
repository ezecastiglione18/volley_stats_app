...
const List<LegalSection> termsConditionsSections = [
  ...
  LegalSection(
    ...
    'La versión premium de RallyStats en Android se contrata como una suscripción mensual '
        ...
        'fecha. Las cuentas nuevas tienen un período de prueba de 7 días corridos desde su '
        'creación durante el cual la app no bloquea el acceso aunque no haya suscripción activa '
        '(ese período no desbloquea por sí solo las funciones premium: solo pospone el bloqueo '
        'general de la app).\n\n'
